<template>
  <div class="root">
    ...
    <div class="menu" :class="{open: menu}">
      <div class="burger" @click="menu = !menu">
        ...
        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 19.1 15.6" style="enable-background:new 0 0 19.1 15.6;" xml:space="preserve">
  ...
  <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 21.2 28.6" style="enable-background:new 0 0 21.2 28.6;" xml:space="preserve">
  <rect y="-0.3" class="st29" width="30.2" height="28.8"/>
  <title>Asset 13</title>
	<path class="st0" d="M0.7,28.6C0.2,28.4,0,28,0,27.4c0-7.6,0-15.2,0-22.7C0,4,0.2,3.7,0.9,3.6C6.2,2.4,11.5,1.2,16.8,0
	...
	<path class="st0" d="M9.3,12.8c-0.2,0.6-0.4,1.2-0.6,1.8c-0.1,0.3-0.3,0.6-0.6,0.7c-0.5,0.2-1-0.1-1.2-0.6
	...
	<path class="st0" d="M6.1,20.5c0,0.8,0,1.6,0,2.4c0,0.5-0.2,0.9-0.6,1c-0.6,0.2-1.2-0.2-1.2-0.9c0-0.8,0-1.6,0-2.4
	...
	<path class="st0" d="M16.9,19.4c0,0.7,0.1,1.4,0,2.1c-0.1,1.1-0.7,1.9-1.8,2.3c-1.1,0.4-2.2,0.2-3-0.6c-0.5-0.5-0.7-1.1-0.8-1.8
	...
	<path class="st0" d="M14.3,12.7c0,0.3,0,0.5,0,0.8c0.1,0,0.2,0,0.3,0c0.5,0,1.1,0,1.6,0c0.5,0,0.9,0.4,0.9,0.9
    ...
    <transition name="pageChange" mode="out-in">
      ...
      <div class="startPage" v-if="startPage" key="start">
        <div class="banner">
          <h2>Who dis?</h2>
          <p class="highlight">Mindfish er en net-resturang som spesialiserer seg på sushi takeout. Det finnes ingen fysisk resturang for mindfish. alle bestilinger foregår over net eller tlf of vil bli brakt til din adresse direkte fra kjøkkenet.</p>
          <!--<h3>About</h3>
      ...
      <div class="menuPage" v-else key="menu">
        ...
        <div class="layout__container">
          <div v-if="list.type === `image`" id="layout__list" @click="list.type = `list`">
            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 30.2 28.8" style="enable-background:new 0 0 30.2 28.8;" xml:space="preserve">
              <title>Asset 13</title>
    ...
    return {
      ...
      items: [
        ...
        },
        {
          ...
          orders: 0,
          value: 89,
          css: "background-image: url(https://imbo.vgc.no/users/godt/images/0af290ea79b493e176084729870e0b4c.jpg?t%5B0%5D=resize%3Awidth%3D980&t%5B1%5D=strip&t%5B2%5D=compress%3Alevel%3D75&t%5B3%5D=progressive&accessToken=2a4a9ebc136f56d46692f505106761ceeacefc16d36065252e03f3e3449704af)"
        },
        {
          id: 8,
          header: false,
        ...
        },
        {
          ...
          type: "Sushi",
          subtype: "Ura maki",
          bio: "Uramaki is a maki sushi roll with the nori on the inside. The nori is covered with an ingredient such as rice. This is an American innovation that's never been very popular in Japan. Japanese maki are designed to be eaten by hand and sushi rice is too sticky to touch.",
          image: "",
        },
        {
          id: 20,
        ...
        },
        {
          ...
          subtype: "Gunkan maki",
          name: "Nigiri",
          bio: "Gunkan maki, also known as Battleship maki, is a common, more traditional type of sushi. It is topped with ikura (fish eggs, larger than tobiko, which is what was used on the Boston Roll), so it is very salty",
          orders: 0,
          value: 0,
        },
        {
        ...
        },
        {
          ...
          subtype: "Sashimi",
          name: "Nigiri",
          bio: "Sashimi is a Japanese delicacy consisting of fresh raw fish or meat sliced into thin pieces and often eaten with soy sauce. ",
          orders: 0,
          value: 0,
        },
        {
          ...
          orders: 0,
          value: 189,
          css: "background-image: url(https://sushimarbella.es/cart/prodimages/13.jpg)"
        },
        {
          id: 34,
          header: false,
          ...
          orders: 0,
          value: 189,
          css: "background-image: url(https://www.nishi.no/wp-content/uploads/Sashimi-Tunfisk-Nishi-Sushi-Oslo-480x270.jpg)"
        },
        {
          id: 35,
          header: false,
          ...
          orders: 0,
          value: 169,
          css: "background-image: url(https://www.nydalensushi.no/custom/images/31b-nydalen-sushi.jpg)"
        },
        {
          id: 36,
          header: false,
          ...
          orders: 0,
          value: 189,
          css: "background-image: url(https://www.visit-kongsberg.no/wp-content/uploads/2018/08/2C.jpg)"
        },
        {
          id: 37,
          header: false,
          ...
          orders: 0,
          value: 179,
          css: "background-image: url(https://favy-inbound-singapore.s3.amazonaws.com/uploads/topic_item/image/73569/retina_maguro_shoten_sushi.jpeg)"
        },
        {
          id: 38,
          header: false,
          ...
          orders: 0,
          value: 169,
          css: "background-image: url(https://www.matsuhisarestaurants.com/wp-content/uploads/2019/07/shutterstock_660580252.jpg)"
        },
        {
          id: 39,
          header: false,
        ...
        },
        {
          ...
          subtype: "Drinks",
          name: "Nigiri",
          bio: "Common types of drinks include plain drinking water, milk, coffee, tea, hot chocolate, juice and soft drinks. In addition, alcoholic drinks such as wine, beer, and liquor, which contain the drug ethanol, have been part of human culture for more than 8,000 years.",
          orders: 0,
          value: 0,
        },
        {
        ...
        },
        {
          ...
          subtype: "Sides",
          name: "Nigiri",
          bio: "A side dish, sometimes referred to as a side order, side item, or simply a side, is a food item that accompanies the entrée or main course at a meal.",
          orders: 0,
          value: 0,
        },
        {
